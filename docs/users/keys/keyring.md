...
MY_VALIDATOR_ADDRESS=$(mcoind keys show dev0 -a)
```
...
yes $KEYPASSWD | mcoind keys add me
yes $KEYPASSWD | mcoind keys show me
# start mcoind with keyring-backend flag
mcoind --keyring-backend=file start
```
