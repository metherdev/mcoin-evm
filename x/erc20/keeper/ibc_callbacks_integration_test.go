...
var _ = Describe("Convert receiving IBC to Erc20", Ordered, func() {
	...
	Describe("enabled params and registered uosmo", func() {
		...
		It("should transfer and not convert mcoin", func() {
			// Register 'mcoin' coin in ERC-20 keeper to validate it is not converting the coins when receiving 'mcoin' thru IBC
			...
			// 1. Send mcoin from Evmos to Osmosis
			...
			// check ibc mcoin coins balance on Osmosis
			...
			// 2. Send mcoin IBC coins from Osmosis to Evmos
			...
			// check ibc mcoin coins balance on Osmosis - should be zero
			...
			// check mcoin balance after transfer - should be equal to initial balance
	...
	Describe("Performing claims with registered coin", func() {
		...
		It("it should perform the claim and convert the received tokens", func() {
			...
			// should trigger claims logic and send mcoin coins from claims to receiver
