...
Find below a list of  `mcoind` commands added with the  `x/revenue` module. You can obtain the full list by using the `mcoind -h` command. A CLI command can look like this:

```bash
mcoind query revenue params
```
